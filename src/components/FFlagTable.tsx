...
export default class FFlagTable extends Component<
  FFlagTableProps & FFlagDataCallbacks
> {
  render() {
    return (
      <MUIDataTable
        ...
        options={{
          ...
          customToolbar: () => (
            <Fragment>
              ...
              >
                <InputLabel htmlFor="series">Bucket</InputLabel>
                <Select
                  value={this.props.series}
                  onChange={(e) =>
                    this.props.setSeries(e.target.value as string)
                  }
                  input={<Input name="series" id="series" />}
                >
